...
export default function EmployeesUpdate(props: any) {
  ...
  const getData = async () => {
    setLoaderPage(true);
      await axios
        .get(`/api/employees/single?emp_id=${searchParams.emp_id}`)
        .then((response: any) => {
            setData(response.data.data);
            const {emp_id, emp_name, emp_gender, emp_birthday} = response.data.data;

            setValue("emp_id", emp_id);
            setValue("emp_name", emp_name);
            setValue("emp_gender", emp_gender);
            setValue("emp_birthday", new Date(emp_birthday));
  ...
  const onSubmit = async (data: any) => {
    ...
    axios.put('/api/employees', dataToUpdate).then((response: any) => {
